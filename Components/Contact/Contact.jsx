...
const Contact = () => {
  ...
  const onSubmit = async (event) => {
    ...
    formData.append("access_key", "e53328ff-9847-4e49-a5f3-c502bd033dc3");
  ...
  return (
    <div className='contact'>
      <div className="contact-col">
        ...
        <ul>
            <li><img src={mail_icon}/>contact@jiten.sahu</li>
            <li><img src={phone_icon}/>+91 123-456-7890</li>
            <li><img src={location_icon}/>297, abcd street, BHHJ <br /> New York, USA</li>
        </ul>
    </div>
      <div className="contact-col">
        <form onSubmit={onSubmit}>
            ...
            <textarea name="message" rows="6" placeholder='Enter you massage' required></textarea>
